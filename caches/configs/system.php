...
'cookie_pre' => 'QGwhn_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://localhost/v9/uploadfile/', //附件路径
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'G7xPe5oOf9AFdh8lgq9P', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost/v9/phpsso_server',	//接口地址
'phpsso_auth_key' => 'Kw0pLDHT5sFsi9GnkwDZClxU580ASuxa', //加密密钥
