...
<h6 class="title"> 个人资料管理</h6>
            <ul class="left-info">
                <li<?php if(ROUTE_A=="company" && ROUTE_C=="business") { ?> class="on"<?php } ?>><a href="index.php?m=yp&c=business&a=company&t=3" hidefocus="true">个人资料</a></li>
